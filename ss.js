...
const weapon = {
  ...
  센티넬:[
    {
      name: "살라만드라",
      stat: { 공격력: [811, 944], 공격력퍼센트: [12, 25], 모든타격피해: [6, 12] },
    },
  ],
  파랑매:[
    { name: "쯔바이", stat: {} },
...
const item = {
  ...
  목걸이: [
    { name: "없음", stat: {} },
    { name: "목 마른 이의 구원", stat: { 공격력퍼센트: [7, 15], 치명타확률: [6, 6] } },
    { name: "투귀의 눈", stat: { 치명타피해: [8, 18], 명속성강화: [10, 20] } },
    { name: "벼락 수집가", stat: { 치명타피해: [14, 30], 스킬재사용속도: [6, 12] } },
    {
      name: "마나 강탈기",
      stat: { 공격력퍼센트: [10, 20], 공격속도: [6, 12], 캐스팅차지속도: [6, 12] },
    },
  ],
  팔찌: [
    { name: "없음", stat: {} },
    ...
    {
      name: "브레이브 블루",
      stat: { 치명타피해: [20, 40], 체력퍼센트: [6, 12], 초당마나재생: [5, 10] },
    },
    {
      name: "능력 증폭 장치",
  ...
  반지: [
    ...
    {
      name: "영광의 상징",
      stat: { 치명타확률: [6, 12], 암속성강화: [12, 25], 초당마나재생: [6, 12] },
    },
    {
      name: "잊힌 전설",
      stat: { 명속성강화: [12, 25], 마나: [200, 400], 스킬재사용속도: [10, 20] },
    },
    { name: "에일리언 오파츠", stat: { 치명타피해: [22, 44], 모든속성강화: [6, 12] } },
    {
      name: "궤뚫어보는 자",
      stat: { 치명타피해: [6, 12], 모든타격피해: [7, 15], 스킬재사용속도: [7, 7] },
    },
  ],
  머리: [
    { name: "없음", stat: {} },
    {
      name: "초토화 머신",
      stat: { 피해증가: [5, 10], 일반몬스터추가피해: [10, 20], 모든타격피해: [10, 20] },
    },
    {
      name: "속죄자의 긴고아",
      stat: { 모든속성강화: [10, 20], 모든타격피해: [10, 20] },
    },
    { name: "얼굴없는 집행인", stat: { 치명타피해: [14, 30], 피해증가: [10, 20] } },
    {
      name: "썬더볼트",
      stat: { 공격속도: [7, 15], 캐스팅차지속도: [7, 15], 명속성강화: [17, 35] },
    },
    {
      name: "얼어붙은 전사",
      stat: { 치명타피해: [22, 44], 스킬재사용속도: [7, 15] },
    },
    { name: "스컬 페이스", stat: { 치명타확률: [6, 12], 모든속성강화: [15, 30] } },
  ],
  상의: [
    { name: "없음", stat: {} },
    {
      name: "외계의 선물",
      stat: { 공격력퍼센트: [15, 30], 활력퍼센트: [15, 30], 버프효과: [25, 50] },
    },
    {
      name: "넘실거리는 물결 상의",
      stat: { 체력퍼센트: [10, 20], 화속성저항: [165, 165], 스킬재사용속도: [6, 6] },
    },
    {
      name: "식지 않는 열기",
      stat: { 치명타피해: [8, 8], 수속성저항: [165, 165], 활력퍼센트: [10, 20] },
    },
    {
      name: "희생된 자의 유품",
      stat: { 치명타피해: [8, 8], 체력퍼센트: [10, 20], 명속성저항: [165, 165] },
    },
    {
      name: "지치지 않는 정신",
    ...
    { name: "퍼센트펙트 케어", stat: { 치명타확률: [10, 20], 활력퍼센트: [12, 25] } },
  ],
  벨트: [
    { name: "없음", stat: {} },
    {
      name: "비프로스트 벨트",
      stat: { 우두머리추가피해: [7, 10], 캐스팅차지속도: [5, 10], 체력퍼센트: [10, 20] },
    },
    {
      name: "잘려나간 바람",
  ...
  하의: [
    ...
    {
      name: "리미트리스",
      stat: { 백어택피해증가: [6, 12], 체력퍼센트: [10, 20], 몬스터추가피해: [10, 20] },
    },
    {
      name: "해일 드레스",
    ...
    {
      name: "툰드라 스커트",
      stat: { 초당체력재생: [15, 30], 공격력퍼센트: [12, 25], 활력퍼센트: [10, 20] },
    },
    {
      name: "케미컬 포스",
    ...
    {
      name: "사이버네틱 링크",
      stat: { 피해감소: [4, 4], 활력퍼센트: [10, 20], 스킬재사용속도: [15, 30] },
    },
    {
      name: "와이번 레더 팬츠",
  ...
  어깨: [
    ...
    {
      name: "투신의 숨결",
      stat: { 우두머리추가피해: [5, 10], 활력퍼센트: [9, 18], 모든타격피해: [9, 18] },
    },
    {
      name: "비스무트 견장",
    ...
    {
      name: "크림슨 랩터",
      stat: { 초당체력재생: [13, 25], 피해감소: [6, 12], 몬스터추가피해: [12, 25] },
    },
    { name: "세컨드 부스터", stat: { 피해감소: [5, 10], 모든타격피해: [10, 20] } },
