const item = {
  ...
  목걸이: [
    ...
    { name: "벼락 수집가", stat: { 치피: [14, 30], 재속: [6, 12] } },
    {
      name: "마나 강탈기",
      stat: { 공격력퍼: [10, 20], 공속: [6, 12], 캐차속: [6, 12] },
    },
  ],
  팔찌: [
    { name: "없음", stat: {} },
    ...
    { name: "불새 고리", stat: { 피감: [5, 5], 몬추피: [10, 20] } },
    {
      name: "살아있는 혈액",
  ...
  반지: [
    ...
    {
      name: "크리스탈 베인",
      stat: { 재속: [12, 25], 마나소모감소: [5, 10], 버프효과: [12, 25] },
    },
    {
      name: "자혜로운 바다",
      stat: { 공속: [4, 8], 캐차속: [4, 8], 수속강: [10, 20] },
    },
    { name: "피를 삼킨 가시나무", stat: { 모타피: [6, 12], 재속: [5, 10] } },
    {
      name: "영광의 상징",
    ...
    {
      name: "잊힌 전설",
      stat: { 명속강: [12, 25], 마나: [200, 400], 재속: [10, 20] },
    },
    { name: "에일리언 오파츠", stat: { 치피: [22, 44], 모속강: [6, 12] } },
    {
      name: "궤뚫어보는 자",
      stat: { 치피: [6, 12], 모타피: [7, 15], 재속: [7, 7] },
    },
  ],
  머리: [
    { name: "없음", stat: {} },
    ...
    {
      name: "썬더볼트",
      stat: { 공속: [7, 15], 캐차속: [7, 15], 명속강: [17, 35] },
    },
    { name: "얼어붙은 전사", stat: { 치피: [22, 44], 재속: [7, 15] } },
  ...
  상의: [
    ...
    {
      name: "넘실거리는 물결 상의",
      stat: { 체력퍼: [10, 20], 화속저: [165, 165], 재속: [6, 6] },
    },
    {
      name: "식지 않는 열기",
  ...
  벨트: [
    ...
    {
      name: "비프로스트 벨트",
      stat: { 우추피: [7, 10], 캐차속: [5, 10], 체력퍼: [10, 20] },
    },
    {
      name: "잘려나간 바람",
    ...
    {
      name: "플레티넘 고스트",
      stat: { 피감: [7, 15], 수속강: [7, 15], 재속: [7, 15] },
    },
    {
      name: "불도마뱀",
      stat: { 피감: [9, 18], 화속강: [10, 20], 마나소모감소: [12, 12] },
    },
    {
      name: "밤사냥꾼",
      stat: { 방어력: [6, 12], 피감: [6, 6], 암속강: [7, 15] },
    },
    {
      name: "어둠속의 번뜩임",
  ...
  하의: [
    ...
    {
      name: "리미트리스",
      stat: { 백어택: [6, 12], 체력퍼: [10, 20], 몬추피: [10, 20] },
    },
    {
      name: "해일 드레스",
  ...
  신발: [
    ...
    {
      name: "넷러너",
      stat: { 방어력: [6, 12], 치피: [20, 40], 재속: [7, 15] },
    },
    {
      name: "아이언 야크",
  ...
  어깨: [
    ...
    {
      name: "크림슨 랩터",
      stat: { 초당체력재생: [13, 25], 피감: [6, 12], 몬추피: [12, 25] },
    },
    { name: "세컨드 부스터", stat: { 피감: [5, 10], 모타피: [10, 20] } },
